...
import com.kiki.common.weixin.MessageTextEntity;
import com.kiki.common.weixin.SignatureUtil;
import com.kiki.common.weixin.XmlUtil;
    ...
    public String post(@RequestBody String requestBody,
        ...
        try {
            ...
            if("event".equals(message.getMsgType()) && "SCAN".equals(message.getEvent())){
                loginService.savaLoginStatus(message.getTicket(), openid);
